                ...
                <Container maxW='container.lg'>
                    <Row gutter={40}>
                        <Col md={8} sm={8} xs={12}>
                            ...
                            <Text as="p" fontSize="md" mt="4" mb="4">Our goals are to teach Investment Parenting so as to....</Text>
                            <Text as="p" fontSize="md" mt="4" mb="4">
                                <UnorderedList>
                                ...
                                <Text as="p" fontSize="md" mt="4" mb="4">What is Investment Parenting? You agree to: </Text>
                                <Text as="p" fontSize="md" mt="4" mb="4">
                                    <UnorderedList>
